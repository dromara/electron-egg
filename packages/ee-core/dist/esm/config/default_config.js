...
import { env, getBaseDir, getLogDir } from "../ps";
import { SocketIO } from "../const/channel";
var default_config_default = () => {
  return {
    ...
    socketServer: {
      ...
      // is it enabled
      port: 7070,
      // default port (if the port is in use, randomly select one)
      path: "/socket.io/",
      // path
      connectTimeout: 45e3,
      ...
      // the data size of each message 1M
      transports: ["polling", "websocket"],
      // http polling or websocket
      cors: {
        origin: true
        // http协议时，要设置跨域 类型 Boolean String RegExp Array Function
      },
