...
exports.getElectronCodeDir = getElectronCodeDir;
exports.getFrontendCodeDir = getFrontendCodeDir;
exports.getRootDir = getRootDir;
exports.getBaseDir = getBaseDir;
exports.getElectronDir = getElectronDir;
...
exports.getUserHomeAppDir = getUserHomeAppDir;
exports.getUserHomeHiddenAppDir = getUserHomeHiddenAppDir;
exports.getSocketPort = getSocketPort;
exports.getHttpPort = getHttpPort;
exports.isPackaged = isPackaged;
exports.exit = exit;
exports.makeMessage = makeMessage;
exports.exitChildJob = exitChildJob;
exports.isChildJob = isChildJob;
exports.isChildPoolJob = isChildPoolJob;
...
function getDataDir() {
    ...
    const dataDir = path_1.default.join(base, 'data');
    return dataDir;
}
// 获取日志存储路径 
function getLogDir() {
    const base = isDev() ? getBaseDir() : getUserHomeHiddenAppDir();
    const dir = path_1.default.join(base, 'logs');
    return dir;
}
// 获取bundle文件路径
function getBundleDir(basePath) {
    const base = basePath || process.cwd();
    const dir = path_1.default.join(base, 'public', 'electron');
    return dir;
}
// 获取electron 源码文件路径
function getElectronCodeDir(basePath) {
    const base = basePath || process.cwd();
    const dir = path_1.default.join(base, 'electron');
    return dir;
}
// 获取frontend 源码文件路径
function getFrontendCodeDir(basePath) {
    const base = basePath || process.cwd();
    const dir = path_1.default.join(base, 'frontend');
    return dir;
}
// 获取base目录
function getBaseDir() {
...
function getPublicDir() {
    const dir = path_1.default.join(getBaseDir(), "public");
    return dir;
}
// 获取 额外资源目录
function getExtraResourcesDir() {
    ...
    if (packaged) {
        ...
        // windows和MacOs不一样
        dir = path_1.default.join(execDir, "resources", "extraResources");
        if ((0, is_1.macOS)()) {
            dir = path_1.default.join(execDir, "..", "Resources", "extraResources");
        }
    }
        ...
        // 打包前
        dir = path_1.default.join(execDir, "build", "extraResources");
    }
    return dir;
}
...
function getUserHomeHiddenAppDir() {
    ...
    const dir = path_1.default.join(getUserHomeDir(), appnameDir);
    return dir;
}
// 获取用户家目录中的app目录
