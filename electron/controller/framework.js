...
class FrameworkController {
    ...
    async sqlitedbOperation(args) {
        const { action, name, age, delete_name, update_name, update_age, search_age, data_dir } = args;
        ...
        switch (action) {
            case 'add':
                ...
                break;
            case 'del':
                data.result = await sqlitedbService.delTestDataSqlite(name || delete_name);
                break;
            case 'update':
                data.result = await sqlitedbService.updateTestDataSqlite(update_name, update_age);
                break;
            case 'get':
                data.result = await sqlitedbService.getTestDataSqlite(age || search_age);
                break;
            case 'all':
                data.result = await sqlitedbService.getAllTestDataSqlite();
                break;
            case 'getDataDir':
