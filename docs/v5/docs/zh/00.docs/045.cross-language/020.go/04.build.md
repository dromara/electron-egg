...
#### 生成 go 程序
1. 首先生成前端资源并移动，[**查看教程**](/00.docs/020.basic-features/014.frontend-module/01.introduction)中，`构建前端资源` 部分。
...
ee-bin配置与说明：[**查看**](/00.docs/010.getting-started/050.config/01.dev-config)
...
#### 生成桌面软件
请参见：[**生成软件**](/00.docs/030.build-software/010.build)
