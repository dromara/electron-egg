...
详细说明：[sqlite安装](/00.docs/020.basic-features/050.database/020.sqlite-database)
...
请查看：[debug](/00.docs/020.basic-features/076.debugging)
...
### Demo
框架集成了许多功能demo示例，方便开发者快速入门。查看[demo文档](/07.features/01.demo)

### 生成软件
见教程：[**构建可执行程序**](/00.docs/030.build-software/010.build)
